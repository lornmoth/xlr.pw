// Code generated by qtc from "index_wasm_go.qtpl". DO NOT EDIT.
// See https://github.com/valyala/quicktemplate for details.

//line server/src/meguca/templates/index_wasm_go.qtpl:1
package templates

//line server/src/meguca/templates/index_wasm_go.qtpl:1
import "encoding/json"

//line server/src/meguca/templates/index_wasm_go.qtpl:2
import "meguca/config"

//line server/src/meguca/templates/index_wasm_go.qtpl:3
import "meguca/lang"

//line server/src/meguca/templates/index_wasm_go.qtpl:5
import (
	qtio422016 "io"
...
//line server/src/meguca/templates/index_wasm_go.qtpl:5
func StreamIndexWasm(qw422016 *qt422016.Writer, theme string) {
	//line server/src/meguca/templates/index_wasm_go.qtpl:6
	conf := config.Get()

	//line server/src/meguca/templates/index_wasm_go.qtpl:7
	ln := lang.Get()

	//line server/src/meguca/templates/index_wasm_go.qtpl:8
	...
	//line server/src/meguca/templates/index_wasm_go.qtpl:19
	qw422016.E().S(theme)
	//line server/src/meguca/templates/index_wasm_go.qtpl:19
	qw422016.N().S(`.css"><style id="user-background-style"></style>`)
	//line server/src/meguca/templates/index_wasm_go.qtpl:23
	qw422016.N().S(`<style>body {width: 100vw;height: 100vh;top: 0;left: 0;margin: 0;}.hash-link {display: unset;}#modal-overlay > .modal:not(.show) {display: unset;}</style></head><body><noscript><div class=overlay-container id=noscript-overlay><span>`)
	//line server/src/meguca/templates/index_wasm_go.qtpl:43
	...
	//line server/src/meguca/templates/index_wasm_go.qtpl:50
	...
	//line server/src/meguca/templates/index_wasm_go.qtpl:55
	...
	//line server/src/meguca/templates/index_wasm_go.qtpl:60
	...
	//line server/src/meguca/templates/index_wasm_go.qtpl:65
	...
	//line server/src/meguca/templates/index_wasm_go.qtpl:70
	...
	//line server/src/meguca/templates/index_wasm_go.qtpl:76
	...
	//line server/src/meguca/templates/index_wasm_go.qtpl:77
	qw422016.N().S(ln.UI["syncCount"])
	//line server/src/meguca/templates/index_wasm_go.qtpl:77
	qw422016.N().S(`"></b><b id="sync" class="banner-float svg-link noscript-hide" title="`)
	//line server/src/meguca/templates/index_wasm_go.qtpl:78
	...
	//line server/src/meguca/templates/index_wasm_go.qtpl:88
	qw422016.N().Z(confJSON)
	//line server/src/meguca/templates/index_wasm_go.qtpl:88
	qw422016.N().S(`</script><script id="lang-data" type="application/json">`)
	//line server/src/meguca/templates/index_wasm_go.qtpl:91
	buf, _ := json.Marshal(ln.Common)

	//line server/src/meguca/templates/index_wasm_go.qtpl:92
	qw422016.N().Z(buf)
	//line server/src/meguca/templates/index_wasm_go.qtpl:92
	qw422016.N().S(`</script><script id="board-title-data" type="application/json">`)
	//line server/src/meguca/templates/index_wasm_go.qtpl:95
	buf, _ = json.Marshal(config.GetBoardTitles())

	//line server/src/meguca/templates/index_wasm_go.qtpl:96
	qw422016.N().Z(buf)
	//line server/src/meguca/templates/index_wasm_go.qtpl:96
	qw422016.N().S(`</script><script src="/assets/js/scripts/loader.js"></script></body>`)
//line server/src/meguca/templates/index_wasm_go.qtpl:100
}
